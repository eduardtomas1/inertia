/**
 * Snapshot of the generated Codex App Server 0.157.1 ServerNotification
...
export const CODEX_APP_SERVER_NOTIFICATION_DISPOSITIONS = {
  ...
  // Codex 0.155: thread attachment bookkeeping; Inertia owns its own
  // attachment store and never reads Codex's copy.
  "thread/attachment/updated": "ignored",
  ...
  // Gateway login is provider-owned. Its authorization URL and diagnostic
  // payload never enter Inertia's renderer, transcript, or credential vault.
