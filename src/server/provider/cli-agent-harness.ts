...
} as const satisfies Readonly<Record<Exclude<ProviderId, "gemini" | "kimi" | "antigravity">, AgentHarnessCapabilities>>;

const HARNESS_IDS: Readonly<Record<Exclude<ProviderId, "gemini" | "kimi" | "antigravity">, AgentHarnessId>> = {
  codex: "codex-cli",
  claude: "claude-cli",
  cursor: "cursor-cli",
