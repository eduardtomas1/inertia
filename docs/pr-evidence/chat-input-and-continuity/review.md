...
- Node 22 `npm run check`: 856 files and 9,137 tests passed, 144 expected skips; architecture, lineage, themes, lint, types and production bundle gates passed.
