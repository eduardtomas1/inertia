...
Antigravity's headless mode applies its own approval policy and cannot deliver
approval requests to Inertia, so Private Connect refuses prompts for Antigravity
conversations; use the local provider flow.
