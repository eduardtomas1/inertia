...
| Test-tree text lines | 345,049 | 344,284 |

Seven deleted files contain 760 lines. The whole test-tree change removes a net
765 lines: 24 unit cases retired, two DOM cases added, and one native case removed.
