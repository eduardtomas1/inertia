!macro customCheckAppRunning
  ...
  inertia_check_install_root:
    ...
    ${if} ${Silent}
      DetailPrint "$R1"
      ; Distinguish a live process from a failed identity query in native smoke
      ; evidence. Neither outcome permits changing the installation.
      ${if} $R0 == 0
        SetErrorLevel 1
      ${else}
        SetErrorLevel 2
