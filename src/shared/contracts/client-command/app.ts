    ...
    .object({
      ...
      payload: z
        .object({
          ...
          discordReleaseProvider: providerIdSchema.optional(),
          discordReleaseModel: z.string().trim().max(160).optional(),
          discordReleaseReasoningEffort: z.string().trim().max(40).optional(),
          discordWebhookUrl: z.string().trim().max(500).optional(),
