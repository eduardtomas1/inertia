...
export const RUNTIME_COMMAND_POLICIES = {
  ...
  "support.report.get": shortMutation,
  "support.report.prepare": shortMutation,
  "support.report.validate": reviewOperation,
  "support.report.cancel": reviewOperation,
  ...
  "usage.limits.get": { timeoutMs: 60000, timeoutDelivery: "rejected" },
  "usage.source.save": shortMutation,
  "usage.source.remove": shortMutation,
  "usage.reset.prepare": shortRetrySafe,
  "usage.reset.confirm": { timeoutMs: 60000, timeoutDelivery: "ambiguous" },
