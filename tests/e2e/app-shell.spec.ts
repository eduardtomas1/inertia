...
test("keeps the window alive and reconnects with a rotated capability after a runtime crash", async (_fixtures, testInfo) => {
  await expectRuntimeCrashRecovery(app, testInfo);
});
