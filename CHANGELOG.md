...
- Conversation detail subscriptions, delayed Git/files/review responses, activity actions, and native preview requests now carry explicit pane ownership so stale work from one project cannot replace or navigate the other.
