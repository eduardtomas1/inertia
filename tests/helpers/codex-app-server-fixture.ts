...
if (message.method === "turn/start") {
  ...
  if (process.env.INERTIA_APP_SERVER_SCENARIO === "rich-item-events") {
    sendBatch([
      ...
      { method: "autoApprovalReview/strictReviewRequired", params: { threadId: "thread-unrelated", turnId, startedAtMs: Date.now() } },
      ...
      { method: "autoApprovalReview/strictReviewRequired", params: { threadId, turnId, startedAtMs: Date.now() } },
      { method: "project/changed", params: { projectId: "codex-project", changeType: "updated" } },
